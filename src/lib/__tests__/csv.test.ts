...
function makeYearlyResult(overrides: Partial<YearlyResult> = {}): YearlyResult {
  return {
    ...
    scpiFullFrenchScenarioTotalTaxes: 2600,
    scpiFullFrenchScenarioFiscalImpact: 300,
    scpiFullFrenchScenarioAverageTaxRate: 0.24,
    scpiFullFrenchScenarioAverageScpiTaxRate: 0.39,
